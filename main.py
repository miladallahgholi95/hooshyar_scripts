...
from scripts import (source_to_elastic, ingest_data_to_elastic, ingest_type_to_elastic, ingest_level_to_elastic,
                     ...
                     ingest_references_to_elastic, ingest_clustering_to_elastic, ingest_actors_to_elastic, ingest_vectors_to_elastic, ingest_affect_detail_to_elastic)
from utils.balebot import send_bale_message
import traceback

error_message = None
MESSAGE = f"سلام وقت بخیر\n**اسناد هوشیار و هوشیار سرویس آپدیت شدند.**\n**تاریخ آخرین خزش:** {UPLOAD_DATE}"
try:
    print("------------------------------------------\nExtract ZIP File\n------------------------------------------")
    ...
    send_bale_message(error_message)
